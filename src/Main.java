...
public class Main{
    public static void main(String[] args) {
        ...
        switch (a) {
            ...
            case 20:
                ...
                break;
            default:
                System.out.println("Непрвильный выбор. Попробуйте снова.");
        }
    }
    ...
    private static void workerManagerTask() {
        ...
        Manager manager = new Manager("Сергей", 18, 200000);
        Worker worker1 = new Worker("Иван", 25, 40500);
        Worker worker2 = new Worker("Петр", 30, 75400);
    ...
    private static void bankTask() {
        class BankAccount {
            ...
            public void withdraw(double amount) {
                if (amount > 0 && amount <= balance) {
                    balance -= amount;
                    System.out.println("Средств сняты: " + amount);
                } else {
        ...
        BankAccount account = new BankAccount("123421", 99999);
        account.deposit(6585);
    ...
    private static void counterTask() {
        ...
        new Counter();
        new Counter();
        System.out.println("Кол-во созданных объектов: " + Counter.getObjectCount());
    }
    ...
    private static void storeTask() {
        ...
        store.addProduct(new Product("Яблоко", 10.2, 100));
        store.addProduct(new Product("Банан", 8.8, 50));
        store.displayProducts();
        store.removeProduct("Яблоко");
        store.displayProducts();
        System.out.println("Найденный продукт: " + store.findProduct("Банан"));
    }
    ...
    private static void orderSystemTask() {
        ...
        class Order {
            ...
            @Override
            public String toString() {
                return "Order: " + products.toString() + ", Total: " + getTotalPrice() + "руб";
            }
        }

        System.out.println("\nЗадание 18: Автоматизированная система заказов");
        Product apple = new Product("Яблоко", 15.5);
        Product banana = new Product("Банан", 11.8);
